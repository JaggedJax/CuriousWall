...
if (!isset($_POST['parenttopicid']) && $_POST['postortopic'] == 'topic') {
	$_POST['parenttopicid'] = $_POST['id'];
}

if (!is_numeric($_POST['id']))
	die('Can not understand post data :(');
...
if ($_POST['postortopic'] == 'topic') {
	...
	die("Sorry, but we do not have the necessary post data to delete a post");
}
